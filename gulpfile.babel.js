...
gulp.task('jekyll', () => {
    const jekyll = cp.spawn('jekyll', ['bundle exec build', '--watch','--incremental','--drafts','--config', 'src/_config.yml' ,'--source', 'src', '--destination', 'dist']);
...
/*gulp.task('critical', ['build'], function (cb) {
    critical.generate({
        ...
        base: 'dist/',
        src: 'index.html',
        dest: 'src/_includes/critical-index.css',
        minify: true
    });
});*/
